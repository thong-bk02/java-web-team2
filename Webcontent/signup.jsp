         ...
         <div class="card-body p-5 shadow-5 text-center">
           ...
           <form>
             <div class="row">
               <div class="col-md-6 mb-2">
                 <div class="form-outline">
                   ...
                   <label class="form-label fs-5" for="form3Example1">First name</label>
                 </div>
               </div>
               <div class="col-md-6 mb-2">
                 <div class="form-outline">
                   <input type="text" id="form3Example2" class="form-control" />
                   <label class="form-label fs-5" for="form3Example2">Last name</label>
                 </div>
               </div>
             </div>
             ...
             <div class="form-check d-flex justify-content-center mb-4">
               ...
               <label class="form-check-label fs-5" for="form2Example33"> Subscribe to our newsletter</label>
             </div>
